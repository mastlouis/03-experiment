...
d3.csv("https://raw.githubusercontent.com/mastlouis/03-experiment/Pie-Charts/data.csv").then(function (data) {
  let numBars = 10
  let row = 0
  let markedBar1 = 0
  let markedBar2 = 0
  ...
  d3.csv("./dots.csv").then( function (dots) {
    console.log(dots)
    markedBar1 = dots[row][0]
    markedBar2 = dots[row][1]
